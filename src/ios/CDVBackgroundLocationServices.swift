...
@objc(HWPBackgroundLocationServices) class BackgroundLocationServices : CDVPlugin {
    ...
    @objc(registerForLocationUpdates:) func registerForLocationUpdates(command: CDVInvokedUrlCommand) {
        log(message: "registerForLocationUpdates");
        locationUpdateCallback = command.callbackId;
        locationCommandDelegate = commandDelegate;
    }

    @objc(registerForActivityUpdates:) func registerForActivityUpdates(command : CDVInvokedUrlCommand) {
    ...
    @objc(getVersion:) func getVersion(command: CDVInvokedUrlCommand) {
    ...
    @objc(startAggressiveTracking:) func startAggressiveTracking(command: CDVInvokedUrlCommand) {
